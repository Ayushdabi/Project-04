	...
	<center>
		...
		<form action="<%=ORSView.PRODUCT_CTL%>" method="post">
			...
			<table>
				...
				<tr>
					<%-- 			<th align="left">Product Price <span style="color: red">*</span> :</th>
					 
					 <td><input type="text" name="ProductAmmount"
						placeholder="Enter Produc Ammount" size="25"
					...
					<%-- <% 
							...
							String hlist = HTMLUtility.getList("ProductAmmount", String.valueOf(bean.getProductAmmount()), map);
						%> <%=hlist%>
					</td>
					<td style="position: fixed"><font color="red"> <%=ServletUtility.getErrorMessage("ProductAmmount", request)%></font></td>
				...
				<tr>
					...
					<td><%=HTMLUtility.getList("ProductAmmount", String.valueOf(bean.getProductAmmount()), rlist)%></td>
					<td style="position: fixed"><font style="position: fixed"
						color="red"> <%=ServletUtility.getErrorMessage("ProductAmmount", request)%></font></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="ProductStatus"
						placeholder="Enter  Product Status" size="25"
						value="<%=DataUtility.getStringData(bean.getProductStatus())%>"></td>
				...
				<tr>
					...
					<td><input type="text" name="purchaseDate"
						placeholder="Enter Purchase Date" size="25" id="udatee"
